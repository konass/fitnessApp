...
private fun startTimer() = with(binding){ // счетчик
 timer = object: CountDownTimer(COUNT_DOWN_TIME, 1){ // ОБЪЕКТ ДЛЯ ВЫЗОВА КОЛБЭКА
...
FragmentManager.setFragment(ExersizeFragment.newInstance(), activity as AppCompatActivity)
     }
